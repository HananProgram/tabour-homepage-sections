...
@section('content')
    <div class="p-6">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('superadmin.homepage-sections.create') }}"
                    ...
                    <li class="flex justify-between items-center py-3" data-id="{{ $section->id }}">
                        <div class="flex items-center">
                            <span class="cursor-grab mr-3">
                                <svg class="w-5 h-5 text-gray-400 mr-3 cursor-grab" fill="none" stroke="currentColor"
                            ...
                            <div>
                                ...
                                <span class="font-medium text-gray-800">
                                    @trk("homepage.{$typeKey}.title.{$section->id}", (string) ($section->title ?? ucfirst(str_replace('_', ' ', $section->type))), 'ui')
                                </span>
