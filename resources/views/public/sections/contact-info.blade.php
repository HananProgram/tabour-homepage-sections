  ...
  <div class="mx-auto max-w-7xl px-6">
    ...
    <div class="mb-8">
      <div class="relative overflow-hidden rounded-2xl">
        <div class="h-36 md:h-44 w-full rounded-2xl bg-gradient-to-r from-sky-600 via-blue-700 to-indigo-800
                    dark:from-sky-700 dark:via-blue-800 dark:to-indigo-900"></div>
        <div class="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
          ...
          @if(filled($section->subtitle))
            <p class="mt-2 max-w-2xl mx-auto text-white/90">
    ...
    {{-- شريط الخريطة بعرض الصفحة --}}
    <div class="mb-8">
      <div class="rounded-2xl overflow-hidden ring-1 ring-gray-200 dark:ring-slate-700 bg-white dark:bg-slate-900">
        @if(!empty($c['map_embed']))
          <div class="aspect-[4/1] w-full [&_iframe]:w-full [&_iframe]:h-full [&_iframe]:border-0">
            {!! $c['map_embed'] !!}
          </div>
        @else
          <div class="h-72 flex items-center justify-center text-gray-400 dark:text-slate-500 text-sm">
    ...
    {{-- تذييل داكن بمعلومات التواصل مثل الصورة --}}
    <div class="rounded-2xl bg-slate-900 text-slate-100 px-6 py-8 md:py-10 shadow-lg">
